...
class TestMessage:
    ...
    def test_message_creation_with_defaults(self):
        ...
        message = Message(msg="Hello, world!", source=SourceEnum.user)
    ...
    def test_message_source_validation(self):
        ...
        assistant_message = Message(
            msg="Assistant message", source=SourceEnum.assistant
        )
    ...
    def test_message_serialization(self):
        ...
        message = Message(msg="Test serialization", source=SourceEnum.user)
...
class TestChat:
    ...
    def test_chat_creation_with_defaults(self):
        ...
        chat = Chat(token="test-token-123", messages=[], name="Test User")
    ...
    def test_chat_creation_with_messages(self):
        ...
        chat = Chat(token="test-token-456", messages=messages, name="Test User")
    ...
    def test_chat_serialization(self):
        ...
        messages = [Message(msg="Test message", source=SourceEnum.user)]
    ...
    def test_chat_large_message_list(self):
        ...
        messages = [
            Message(
                msg=f"Message {i}",
                source=SourceEnum.user if i % 2 == 0 else SourceEnum.assistant,
            )
            for i in range(100)
        ]

        chat = Chat(token="test-large-chat", messages=messages, name="Heavy User")
    ...
    def test_chat_message_validation(self):
        ...
        with pytest.raises(ValidationError):
            Chat(token="test-token", messages=invalid_message_data, name="Test User")
...
class TestSchemaIntegration:
    ...
    def test_complete_chat_flow(self):
        ...
        chat = Chat(
            token="integration-test-token", messages=[], name="Integration User"
        )

        assert len(chat.messages) == 0

        # Add user message
        user_message = Message(msg="Hello, AI!", source=SourceEnum.user)
        chat.messages.append(user_message)

        # Add assistant response
        assistant_message = Message(
            msg="Hello! How can I help you today?", source=SourceEnum.assistant
        )
        chat.messages.append(assistant_message)

        # Add another user message
        follow_up = Message(msg="What's the weather like?", source=SourceEnum.user)
    ...
    def test_json_compatibility(self):
        ...
        chat = Chat(
            ...
            messages=[Message(msg="JSON test", source=SourceEnum.user)],
            name="JSON User",
        )
