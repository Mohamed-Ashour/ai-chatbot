...
class TestMessage:
    ...
    def test_message_creation_with_defaults(self):
        ...
        message = Message(msg="Test message", source=SourceEnum.user)
    ...
    def test_message_with_assistant_source(self):
        ...
        message = Message(msg="I'm here to help!", source=SourceEnum.assistant)
    ...
    def test_message_validation_invalid_source(self):
        ...
        with pytest.raises(ValidationError):
            Message(msg="Test message", source="invalid_source")
    ...
    def test_message_inequality(self):
        ...
        message1 = Message(msg="Message 1", source=SourceEnum.user)

        message2 = Message(msg="Message 2", source=SourceEnum.user)
